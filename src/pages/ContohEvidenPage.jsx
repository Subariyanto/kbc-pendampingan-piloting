...
function FormatUmum({ item }) {
  return <p className="text-center text-slate-500 py-8">Template "{item.judul}" GÇö format dapat disesuaikan oleh madrasah.</p>
}
